...
class Properties extends Hashtable {
    ...
    //@ invariant keyType == \type(String)
    //@ invariant elementType == \type(String)
     ...
     * @since    JDK1.2
     */
    public synchronized Object setProperty(/*@non_null*/ String key,
     ...
     */
    private boolean continueLine (/*@non_null*/ String line) {
        int slashCount = 0;
     ...
     */
    //@ ensures \result!=null
    private String loadConvert (/*@non_null*/ String theString) {
        char aChar;
     ...
     */
    private String saveConvert(/*@non_null*/ String theString) {
        char aChar;
        int len = theString.length();
    ...
    private static void writeln(/*@non_null*/ BufferedWriter bw, String s) throws IOException {
        bw.write(s);
        bw.newLine();
    }
     ...
     */
    public String getProperty(/*@non_null*/ String key) {
     ...
     * @see     java.util.Properties#defaults
     */
    //@ ensures defaultValue!=null ==> \result!=null
    public String getProperty(/*@non_null*/ String key, String defaultValue) {
	...
	//@ set h.keyType = \type(String)
	//@ set h.elementType = \type(String)
     ...
     * @param   out   an output stream.
     */
    public void list(/*@non_null*/ PrintStream out) {
     ...
     * compile this file.
     */
    public void list(/*@non_null*/ PrintWriter out) {
	out.println("-- listing properties --");
	Hashtable h = new Hashtable();
	//@ set h.keyType = \type(String)
	//@ set h.elementType = \type(String)
     ...
     */
    //@ requires h.keyType == \type(String)
    //@ requires h.elementType == \type(String)
    private synchronized void enumerate(/*@non_null*/ Hashtable h) {
	if (defaults != null) {
