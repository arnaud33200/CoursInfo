...
public abstract class AbstractList extends AbstractCollection implements List {
	...
	//@ invariant elementType == AbstractList.this.elementType
	//@ invariant returnsNull == AbstractList.this.containsNull


	// Added for spec purposes:
	Itr() {
	    //@ set elementType = AbstractList.this.elementType
	    //@ set returnsNull = AbstractList.this.containsNull
	}
...
class SubList extends AbstractList {
    //@ invariant elementType == l.elementType
    //@ invariant containsNull == l.containsNull

    private /*@non_null*/ AbstractList l;
    private int offset;
    private int size;
    ...
    //@ ensures elementType == list.elementType
    //@ ensures containsNull == list.containsNull
    SubList(/*@non_null*/ AbstractList list, int fromIndex, int toIndex) {
        if (fromIndex < 0)
	...
	//@ set elementType = l.elementType
	//@ set containsNull = l.containsNull
    }
