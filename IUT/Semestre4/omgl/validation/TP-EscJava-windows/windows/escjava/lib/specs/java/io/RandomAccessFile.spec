...
public class RandomAccessFile implements DataOutput, DataInput {
     ...
     * writeable or not.
     */
    // below discovered empirically -- mdl
    //@ requires name!=null
     ...
     * @exception  IOException  if an I/O error occurs.
     */
    public int read(/*@non_null*/ byte b[]) throws IOException {
