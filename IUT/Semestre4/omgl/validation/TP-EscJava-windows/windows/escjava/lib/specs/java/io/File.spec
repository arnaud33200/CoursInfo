...
public class File implements java.io.Serializable, Comparable {
     ...
     */
    static private /*@non_null*/ FileSystem fs = FileSystem.getFileSystem();
...

     ...
     */
    private File(/*@non_null*/ String pathname, int prefixLength) {
	this.path = pathname;
     ...
     */
    public File(/*@non_null*/ String pathname) {
	if (pathname == null) {
     ...
     */
    public File(String parent, /*@non_null*/ String child) {
	if (child == null) {
	    throw new NullPointerException();
	}
	if (parent != null) {
     ...
     *          If <code>child</code> is <code>null</code>
     */
    public File(File parent, /*@non_null*/ String child) {
	if (child == null) {
	    throw new NullPointerException();
	}
	if (parent != null) {
...

     ...
     */
    private synchronized void writeObject(/*@non_null*/ java.io.ObjectOutputStream s)
        throws IOException
    {
     ...
     */
    private synchronized void readObject(/*@non_null*/ java.io.ObjectInputStream s)
