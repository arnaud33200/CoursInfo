...
class StringTokenizer implements Enumeration {
    ...
    private /*@non_null*/ String str;
    private /*@non_null*/ String delimiters;
     ...
     *                         as tokens.
     */
    public StringTokenizer(/*@non_null*/ String str, /*@non_null*/ String delim, boolean returnTokens) {
	currentPosition = 0;
	this.str = str;
     ...
     * @param   delim   the delimiters.
     */
    public StringTokenizer(/*@non_null*/ String str, /*@non_null*/ String delim) {
     ...
     * @param   str   a string to be parsed.
     */
    public StringTokenizer(/*@non_null*/ String str) {
	this(str, " \t\n\r\f", false);
    }
	...
	skipDelimiters();
	//@ set moreElements = currentPosition < maxPosition
     ...
     *               tokenizer's string.
     */
    public String nextToken(/*@non_null*/ String delim) {
	delimiters = delim;
	return nextToken();
    }
