...
public final class Float extends Number implements Comparable {
     ...
     */
    //@ ensures \result!=null
    public static Float valueOf(/*@non_null*/ String s) throws NumberFormatException {
     ...
     * @since      JDK1.2
     */
    public static float parseFloat(/*@non_null*/ String s) throws NumberFormatException {
     ...
     */
    public Float(/*@non_null*/ String s) throws NumberFormatException {
	...
	return compareTo((Float)o);          //@ nowarn Cast;
    }
