...
public class BitSet implements Cloneable, java.io.Serializable {
     ...
     * @serial
     */
    private /*@non_null*/ long bits[];  // this should be called unit[]
     ...
     * @since     JDK1.2
     */
    public void andNot(/*@non_null*/ BitSet set) {
     ...
     * @param   set   a bit set. 
     */
    public void and(/*@non_null*/ BitSet set) {
	if (this == set)
	    return;
     ...
     * @param   set   a bit set.
     */
    public void or(/*@non_null*/ BitSet set) {
	if (this == set)
	    return;
     ...
     * @param   set   a bit set.
     */
    public void xor(/*@non_null*/ BitSet set) {
        int unitsInCommon;
     ...
     *
     */
    private void readObject(/*@non_null*/ java.io.ObjectInputStream in)
