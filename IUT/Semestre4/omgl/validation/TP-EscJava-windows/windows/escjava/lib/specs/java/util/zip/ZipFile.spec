...
class ZipFile implements ZipConstants {
    ...
    private /*@non_null*/ String name;  // zip file name
     ...
     */
    public ZipFile(/*@non_null*/ String name) throws IOException {
	...
	//@ set inflaters.elementType = \type(Inflater)
	//@ set inflaters.containsNull = false
    }
     ...
     * @exception IOException if an I/O error has occurred
     */
    public ZipFile(/*@non_null*/ File file) throws ZipException, IOException {
	this(file.getPath());
    }
     ...
     */
    //@ ensures \result!=null
    public InputStream getInputStream(/*@non_null*/ ZipEntry entry)
	                    throws IOException {
     ...
     */
    private void releaseInflater(/*@non_null*/ Inflater inf) {
	synchronized (inflaters) {
	    inflaters.add(inf);
	}
    }
    ...
    //@ invariant inflaters.elementType == \type(Inflater)
    //@ invariant !inflaters.containsNull
    private /*@non_null*/ Vector inflaters = new Vector();
    ...
    //@ ensures \result.elementType == \type(ZipEntry)
