...
class String implements java.io.Serializable, Comparable {
    ...
    private static ByteToCharConverter
                      getBTCConverter(/*@non_null*/ String encoding)
     ...
     */
    //@ ensures \result!=null
    private static CharToByteConverter
		      getCTBConverter(/*@non_null*/ String encoding)
                                  throws UnsupportedEncodingException {
     ...
     */
    public String(/*@non_null*/ String value) {
	count = value.length();
    ...
    //@ requires offset >= 0
    //@ requires count  >= 0
    //@ requires offset <= value.length-count
    public String(/*@non_null*/ char value[], int offset, int count) {
	if (offset < 0) {
    ...
    //@ requires offset>=0
    //@ requires count>=0
    //@ requires offset <= ascii.length-count
    public String(/*@non_null*/ byte ascii[], int hibyte, int offset,
	          int count) {
	if (offset < 0) {
	    throw new StringIndexOutOfBoundsException(offset);
	}
     ...
     * @see        java.lang.String#String(byte[])
     */
    public String(/*@non_null*/ byte ascii[], int hibyte) {
   ...
   /**
    ...
    //@ requires length>=0
    //@ requires offset>=0
    //@ requires offset <= bytes.length-length
    private String(/*@non_null*/ byte bytes[], int offset, int length,
		   /*@non_null*/ ByteToCharConverter btc)
    {
        if (length < 0)
    ...
    //@ requires offset>=0
    //@ requires offset <= bytes.length-length
    public String(/*@non_null*/ byte bytes[], int offset, int length,
		  /*@non_null*/ String enc)
	throws UnsupportedEncodingException
    {
     ...
     * @since      JDK1.1
     */
    public String(/*@non_null*/ byte bytes[], /*@non_null*/ String enc)
	throws UnsupportedEncodingException
    {
    ...
    //@ requires count>=0
    private String(int offset, int count, /*@non_null*/ char value[]) {
	this.value = value;
	this.offset = offset;
	this.count = count;
    }
     ...
     * @exception NullPointerException if <code>dst</code> is <code>null</code>
     */
    public void getBytes(int srcBegin, int srcEnd, /*@non_null*/ byte dst[],
			 int dstBegin) {
	if (srcBegin < 0) {
	    throw new StringIndexOutOfBoundsException(srcBegin);
	} 
     ...
     */
    private byte[] getBytes(/*@non_null*/ CharToByteConverter ctb) {
	ctb.reset();
     ...
     * @since      JDK1.1
     */
    public byte[] getBytes(/*@non_null*/ String enc)
	throws UnsupportedEncodingException
    {
	...
	return compareTo((String)o);   //@ nowarn Cast;
    }
     ...
     *          <tt>null</tt>.
     */
    public boolean regionMatches(int toffset, /*@non_null*/ String other,
				 int ooffset, int len) {
	char ta[] = value;
     ...
     *          <code>null</code>.
     */
    public boolean startsWith(/*@non_null*/ String prefix, int toffset) {
	char ta[] = value;
	int to = offset + toffset;
	int tlim = offset + count;
     ...
     * @since   JDK1. 0
     */
    public boolean startsWith(/*@non_null*/ String prefix) {
     ...
     *          <code>null</code>.
     */
    public boolean endsWith(/*@non_null*/ String suffix) {
    ...
    //@ requires offset>=0
    //@ requires count>=0
    //@ requires offset+count<=data.length
    //@ ensures \result!=null
    public static String valueOf(/*@non_null*/ char data[], int offset,
				 int count) {
    ...
    //@ requires offset+count<=data.length
    //@ ensures \result!=null
    public static String copyValueOf(/*@non_null*/ char data[], int offset,
				     int count) {
