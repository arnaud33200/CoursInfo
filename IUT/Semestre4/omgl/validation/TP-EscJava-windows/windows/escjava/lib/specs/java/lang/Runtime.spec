...
public class Runtime {
    private static /*@non_null*/ Runtime currentRuntime = new Runtime();
     ...
     */
    public Process exec(/*@non_null*/ String command) throws IOException {
     ...
     */
    //@ requires envp!=null ==> \nonnullelements(envp)
    public Process exec(/*@non_null*/ String command, String envp[])
				  throws IOException {
	int count = 0;
	String cmdarray[];
 	StringTokenizer st;
     ...
     * @see        java.lang.SecurityManager#checkExec(java.lang.String)
     */
    //@ requires \nonnullelements(cmdarray)
    //@ requires cmdarray.length>0
    public Process exec(/*@non_null*/ String cmdarray[]) throws IOException {
    ...
    synchronized void load0(Class fromClass, /*@non_null*/ String filename) {
	SecurityManager security = System.getSecurityManager();
	if (security != null) {
