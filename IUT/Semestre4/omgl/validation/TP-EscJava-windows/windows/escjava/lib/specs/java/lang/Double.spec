...
//  public static final double MIN_VALUE = 4.94065645841246544e-324;
     ...
     * @since      JDK1.2
     */
    public static double parseDouble(/*@non_null*/ String s) throws NumberFormatException {
     ...
     */
    public Double(/*@non_null*/ String s) throws NumberFormatException {
    ...
    /**
     * Compare this Double to another Object.  If the Object is a Double,
	...
	return compareTo((Double)o);          //@ nowarn Cast;
    }
