...
class ZipEntry implements ZipConstants, Cloneable {
    /*@non_null*/ String name;	// entry name
     ...
     *		  0xFFFF bytes
     */
    public ZipEntry(/*@non_null*/ String name) {
	if (name == null) {
     ...
     * zip entry.
     */
    public ZipEntry(/*@non_null*/ ZipEntry e) {
	name = e.name;
	time = e.time;
	crc = e.crc;
	size = e.size;
     ...
     */
    ZipEntry(/*@non_null*/ String name, long jzentry) {
	this.name = name;
	initFields(jzentry);
    }
     ...
     *		  method is invalid
     */
    //@ requires method==STORED || method==DEFLATED
