...
##########################################################################
#                                                                        #
#   regroupe les fonctions permettant gérer l'interfasse du menu         #
 ...
 * Description : permet d'entré dans la fenetre option du menu 
...
void menuoption ( SDL_Surface *screen, SDL_Event event, saveconfig &save )
{
	...
	SDL_WM_SetCaption("DIAMANT  (option)", NULL);  
	SDL_WM_SetIcon(icon, NULL);
 ...
 * Description : permet d'entré dans la fenetre introduction
 * Entrées : SDL_Surface screen, SDL_Event event
 * Sorties : rien
************************************************************/
