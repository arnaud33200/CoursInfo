...
##########################################################################
#                                                                        #
#   regroupe les fonctions utilisées pour affichage des images           #
#     -> ces fonctions proviennent du site suivant :                     #
# 	https://sites.google.com/site/iutbdxprojetap12010/pong/atelier-3     #
#                                                                        #
#   ces fonctions ont été mis à disposition des étudiants de l'IUT       #
# 	informatique de Bordeaux 1, et sont utilisées dans un but uniquement #
# 	pedagogique															 #
#                                                                        #
##########################################################################
*/
