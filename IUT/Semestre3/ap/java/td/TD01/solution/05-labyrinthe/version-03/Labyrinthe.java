...
public class Labyrinthe {
    ...
    */
    ...
    public void setLargeur(int j){
	largeur=j;
    }
    
    public void setSallesDefaut(int i,int j){
	salles = new Salle [i][j];
    }

    public void addSalle(Salle s, int i, int j){
	salles[i][j]=s;
    }
    ...
    private int[] getCoordonneesSalle(Salle s){
	int[] res = new int [2];
	res[0]=res[1]=-1;
	int i=0,j=0;
