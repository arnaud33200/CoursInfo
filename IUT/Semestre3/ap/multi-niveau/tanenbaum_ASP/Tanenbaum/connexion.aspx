<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="connexion.aspx.cs" Inherits="Tanenbaum.WebForm3" %>
...
#################################################################################### -->
	...
	<!-- ~~~~~~~~~~~~~~~~~~~~~~~~ AFFICHAGE ~~~~~~~~~~~~~~~~~~~~~ -->	
		...
		<div id="affichage">
            ...
            <br />
            <br />
            <asp:Button ID="valdcon" runat="server" Text="Validez" 
                onclientclick="connect()" onclick="valdcon_Click" />
