...
#define VOCAL_REMOVE_OUTPUT1 2
#define VOCAL_REMOVE_OUTPUT2 3
    ...
    LADSPA_Data * DataLocation)
   {
      switch (Port)
      {
        ...
        case VOCAL_REMOVE_INPUT2:
          ...
          break;
        case VOCAL_REMOVE_OUTPUT1:
          ((VocalRemove *)Instance)->m_pfOutputBuffer1 = DataLocation;
          break;
        case VOCAL_REMOVE_OUTPUT2:
          ((VocalRemove *)Instance)->m_pfOutputBuffer2 = DataLocation;
          break;
...
/* Run a vocal remover line instance for a block of SampleCount samples. */
   void 
    ...
    unsigned long SampleCount)
   {
      ...
      pfOutput1 = psVocalRemove->m_pfOutputBuffer1;
      pfOutput2 = psVocalRemove->m_pfOutputBuffer2;
      pfInput1 = psVocalRemove->m_pfInputBuffer1;
      pfInput2 = psVocalRemove->m_pfInputBuffer2;

      for (lSampleIndex = 0; lSampleIndex < SampleCount; ++lSampleIndex)
      {
        *(pfOutput1++) = *(pfInput1++) - *(pfInput2++);
        *(pfOutput2++) = *(pfInput1++) - *(pfInput2++);
      }
   }
...
/* _init() is called automatically when the plugin library is first
  ...
  _init()
  {
    ...
    if (g_psDescriptor)
    {
      ...
      = LADSPA_PORT_INPUT | LADSPA_PORT_AUDIO;
      piPortDescriptors[VOCAL_REMOVE_OUTPUT1]
      = LADSPA_PORT_OUTPUT | LADSPA_PORT_AUDIO;
      piPortDescriptors[VOCAL_REMOVE_OUTPUT2]
      = LADSPA_PORT_OUTPUT | LADSPA_PORT_AUDIO;
      pcPortNames
      ...
      = strdup("Input2");
      pcPortNames[VOCAL_REMOVE_OUTPUT1]
      = strdup("Output1");
      pcPortNames[VOCAL_REMOVE_OUTPUT2]
      = strdup("Output2");
      ...
      = 0;
      psPortRangeHints[VOCAL_REMOVE_OUTPUT1].HintDescriptor
      = 0;
      psPortRangeHints[VOCAL_REMOVE_OUTPUT2].HintDescriptor
      = 0;
